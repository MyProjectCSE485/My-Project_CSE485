						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="detail-title">
									...
									<a href="muahang8.php"><button type="submit">Đặt Mua</button></a>
								</div>

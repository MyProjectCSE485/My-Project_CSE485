						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="detail-title">
									...
									<a href="muahang5.php"><button type="submit">Đặt Mua</button></a>
								</div>
								<div class="detail-param">
									<table class="table table-hover">
										<tbody>
											...
											<tr>
												<th>CPU:</th>
												<td>Exynos 7870 8 nhân 64-bit</td>
											</tr>
										</tbody>
									</table>
								</div>

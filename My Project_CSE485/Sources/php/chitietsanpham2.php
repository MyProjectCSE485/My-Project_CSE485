...
<body>
	<div id="wrap">
                    ...
                    <div class="row">
							...
							<div class="col-md-6">
								<div class="detail-title">
									...
									<a href="muahang2.php"><button type="submit">Đặt Mua</button></a>
								</div>
		...
		<footer>
			<p>Địa chỉ:16 Nguyễn Khánh Toàn, TP Hà Nội</p><br>
			<p>Tell:0984435480</p><br>
